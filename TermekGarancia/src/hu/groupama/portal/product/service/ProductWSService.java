 ...
 * 
 */
@WebServiceClient(name = "ProductWSService", targetNamespace = "http://service.product.portal.groupama.hu", wsdlLocation = "file:/C:/Users/Laci/git/bizt/TermekGarancia/ProductWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTWSSERVICE_QNAME = new QName("http://service.product.portal.groupama.hu", "ProductWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Laci/git/bizt/TermekGarancia/ProductWS.wsdl");
     ...
     *     returns ProductWS
     */
    @WebEndpoint(name = "ProductWS")
    public ProductWS getProductWS() {
        return super.getPort(new QName("http://service.product.portal.groupama.hu", "ProductWS"), ProductWS.class);
    }
     ...
     */
    @WebEndpoint(name = "ProductWS")
    public ProductWS getProductWS(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.product.portal.groupama.hu", "ProductWS"), ProductWS.class, features);
    }
