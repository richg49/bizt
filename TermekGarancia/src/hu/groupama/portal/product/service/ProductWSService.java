 ...
 * 
 */
@WebServiceClient(name = "ProductWSService", targetNamespace = "http://service.product.portal.groupama.hu", wsdlLocation = "file:/C:/Temp/ProductWS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Temp/ProductWS.wsdl");
